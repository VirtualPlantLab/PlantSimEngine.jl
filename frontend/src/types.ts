...
export type InitializationDescriptor = {
  ...
  variable: string;
  role: GraphPortRole;
  disposition: "generated" | "producer_bound" | "supplied" | "defaulted" | "required" | "environment_bound" | "unresolved";
  value: unknown;
  valueJulia: string;
  expectedType: string;
  ...
  statusTransformApplied: boolean;
  statusTransformChanged: boolean;
  typeMappingApplied: boolean;
  typeMappingChanged: boolean;
  typeMappingRule: unknown;

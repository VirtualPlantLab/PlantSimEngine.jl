...
# Model coupling for modelers {#Model-coupling-for-modelers}

This section uses notions from the previous section. If you are not familiar with the concepts of model coupling in PlantSimEngine, please read the previous section first: [Model coupling for users](/model_coupling/model_coupling_user#Model-coupling-for-users).

    ...
    for symbol in keys(status)
        ...
        if isa(value_534f1c161f91bb346feba1a84a55e8251f5ad446, AbstractVector)
            ...
            if timestep_scale != organ
                scale_expr = repr(timestep_scale)
                model_add_decl = "generated_models_534f1c161f91bb346feba1a84a55e8251f5ad446 = (generated_models_534f1c161f91bb346feba1a84a55e8251f5ad446..., MultiScaleModel(model=$model_name($value_534f1c161f91bb346feba1a84a55e8251f5ad446), mapped_variables=[:current_timestep=>($scale_expr=>:current_timestep)],),)"
            end 
